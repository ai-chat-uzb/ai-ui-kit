  ...
  const accounts = [
    {
      ...
      status: 'online',
      avatarUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKDP-4Dg4s4b6YxTTriW24nV5Q0RL65zh7JA&usqp=CAU'
    },
    {
      id: 2,
      title: 'User 2',
    ...
    },
    {
      ...
      status: 'online',
      avatarUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRo1FuvZGsn2ny3YPNUk6wVqX_eJ1UrjtOg1A&usqp=CAU'
    },
    {
      id: 4,
      title: 'User 4',
      ...
      status: 'online',
      avatarUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT03zupUecXumhgj3FXstRo8oGtKaLD1dlgkQ&usqp=CAU'
    },
    {
      id: 5,
      title: 'User 5',
      ...
      status: 'online',
      avatarUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdNJN959TBK4TmiKEAUUaAvQ56H9ZJWem2yg&usqp=CAU'
    }
  ];
  const [selectedAccount, setSelectedAccount] = useState(accounts[0]);

  const onClick = (id: number) => {
    setSelectedAccount(accounts.filter(item => item.id === id)[0]);
  };
  return (
    <Dropdown
      {...props}
